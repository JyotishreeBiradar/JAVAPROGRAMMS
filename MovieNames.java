class MovieNames
{
  public static void main(String[] args)
  {
	  ...
	  String[] Totalmovienames={movie1,movie2,movie3,movie4,movie5,movie6,movie7,movie8,movie9,movie10,movie11,movie12,movie13,movie14,movie15,movie16,movie17,movie18,movie19,movie20};
	   
	  for(int begin=0;begin<Totalmovienames.length;begin++)
	  {
		
		  System.out.println("Begin:"+Totalmovienames[begin]);
	  }
	  System.out.println(Totalmovienames.length);
